...
return [
    ...
    */
    ...
    'bank' => [
        'name' => env('BANK_NAME', 'Ironside'),
        'account_name' => env('BANK_ACCOUNT_NAME', 'Ironside'),
    ...
    'firebase' => [
        ...
        'auth_domain' => env('FIREBASE_AUTH_DOMAIN', 'Ironsidewebsite-a8b4b.firebaseapp.com'),
        'project_id' => env('FIREBASE_PROJECT_ID', 'Ironsidewebsite-a8b4b'),
        'storage_bucket' => env('FIREBASE_STORAGE_BUCKET', 'Ironsidewebsite-a8b4b.firebasestorage.app'),
